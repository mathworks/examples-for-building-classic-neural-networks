...
%
%  Define two basis vectors and a third vector, then see the
%  third vector's expansion in terms of the two basis vectors.
...
if isempty(fig)
  ...
  H = nndArray({fig_axis desc_text left right});
