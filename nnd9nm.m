...
%
%  Select a point on a surface and see the Newton approximation of the
%  surface around the initial point with its estimated minima. Also see
%  the path taken by iteratively approximating the surface.
