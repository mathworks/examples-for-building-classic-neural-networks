...
%
%  Control the input-output function of a single-input neuron
%  by adjusting its weight, bias and transfer function.
...
elseif strcmp(cmd,'init') & isempty(fig)
  ...
  H = nndArray({fig_axis desc_text meters indicators lines w_ptr b_ptr f_ptr p_ptr ...
    f_menu f_text cross});
