...
%
%  Watch the time response of a Hopfield network for different initial
%  states and different weights, biases and gains.
...
if isempty(fig)
  ...
  set(top_left, ...
    'ButtonDownFcn',nncallbk(me,'down'), ...
    'xlim',[-1 1], ...
    'ylim',[-1 1], ...
  ...
  H = nndArray({fig_axis desc_text bottom_left top_left edit_w11 edit_w12,...
