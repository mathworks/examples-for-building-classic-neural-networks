...
%
%  This demonstration requires Deep Learning Toolbox.

% Copyright 1994-2018 Martin T. Hagan
...
%%%%%%%%
  ...
  'position',[156 173 60 18],...
    'style','edit',...
  'string','1.0',...
    'TooltipString','You can enter the input into this box.',...  %mth 1/25/05
    'callback',[me '(''p'')']);
  ...
  go_button = uicontrol(...
    ...
    'string','Target',...
    'TooltipString','Push this button to continue the demonstration.',...  %mth 1/25/05
    'callback',[me '(''go'')']);
  uicontrol(...
    'units','points',...
    'position',[410 130 60 20],...
    'string','Reset',...
    'TooltipString','This button resets the demonstration.',...  %mth 1/25/05
    'callback',[me '(''reset'')']);
  uicontrol(...
    'units','points',...
    'position',[410 105 60 20],...
    'string','Random',...
    'TooltipString','This button randomizes the weights.',...  %mth 1/25/05
    'callback',[me '(''random'')'])
  uicontrol(...
    'units','points',...
    'position',[410 80 60 20],...
    'string','Contents',...
    'TooltipString','This button takes you back to the Table of Contents window.',...  %mth 1/25/05
    'callback','nndtoc')
  uicontrol(...
    'units','points',...
    'position',[410 55 60 20],...
    'string','Close',...
    'TooltipString','This button closes the current window.',...  %mth 1/25/05
    'callback',[me '(''close'')'])
