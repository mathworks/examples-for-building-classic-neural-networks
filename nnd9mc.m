...
%
%  Choose a starting point on a simple surface, and watch the path
%  taken by steepest descent and conjugate gradient algorithms as they
%  search for the surface minima.
...
if isempty(fig)
  ...
  H = nndArray({fig_axis desc_text left right path1_ptr path2_ptr});
  set(fig,'userdata',H)
