...
%
% Select anywhere on a curve and choose orders of approximation,
% and see the Taylor series approximations of the curve around the
% selected point.
...
if isempty(fig)
  ...
  H = nndArray({fig_axis desc_text left right marker_ptr,...
