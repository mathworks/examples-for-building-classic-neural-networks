function nndhintonw(w,max_m,min_m)
%NNDHINTONW Hinton graph of weight matrix.
%
%  Syntax
%
%    nndhintonw(W,maxw,minw)
%
%  Description
%  
%    NNDHINTONW(W,MAXW,MINW) takes these inputs,
%      W    - SxR weight matrix
