...
%
%  Choose a point on a quadratic surface and see the path to the
%  minima taken by the steepest descent algorithm.
...
if isempty(fig)
  ...
  H = nndArray({fig_axis desc_text graph marker_ptr point_ptr path_ptr ...
    lr_slider lr_text});
  set(fig,'userdata',H)
