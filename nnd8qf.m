...
%
%  Adjust a Hessian matrix, vector and constant and see the surface
%  defined by the resulting quadratic function.
...
if isempty(fig)
  ...
  H = nndArray({fig_axis desc_text bottom_left top_left edit_a11 edit_a12,...
