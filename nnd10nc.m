...
%
%   Choose initial weights, learning rate and momentum and see how
%   well an adaptive filter learns to cancel noise.
...
elseif strcmp(cmd,'init') & isempty(fig)
  ...
  H = nndArray({fig_axis desc_text signal_axis weight_axis ...
...
elseif strcmp(cmd,'mc') & ~isempty(fig)
