...
%
% Select anywhere on a surface and choose orders of approximation,
% and see the Taylor series approximations of the surface around the
% selected point.
...
if isempty(fig)
  ...
  H = nndArray({fig_axis desc_text bottom_left top_left bottom_right top_right,...
