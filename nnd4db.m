...
%
%  Move a Perceptron's decision boundary so that it properly
%  classifies four vectors.
...
elseif strcmp(cmd,'init') & isempty(fig)
  ...
  H = nndArray({fig_axis desc_text v_axis t1_axis cross w_arrow_ptr db_line...
...
elseif strcmp(cmd,'movept1') & ~isempty(fig) & (nargin == 1)
...
elseif strcmp(cmd,'setpt1') & ~isempty(fig) & (nargin == 1)
...
elseif strcmp(cmd,'movept2') & ~isempty(fig) & (nargin == 1)
...
elseif strcmp(cmd,'setpt2') & ~isempty(fig) & (nargin == 1)
