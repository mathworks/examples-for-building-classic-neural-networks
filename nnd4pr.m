...
%
%  Watch a Perceptron update its weight and bias with the
%  Perceptron rule in response to three input vectors and their
%  correct classes, until it is able the vectors without error.
...
elseif strcmp(cmd,'init') & isempty(fig)
  ...
  H = nndArray({fig_axis desc_text v_axis t1_axis cross NaN db_line...
